...
function buildEmailHtml({ subject, body, recipientName }) {
  ...
  const swooshSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 430 110" preserveAspectRatio="none"><defs><linearGradient id="g" x1="1" y1="0" x2="0" y2="0"><stop offset="0" stop-color="#052456"/><stop offset=".45" stop-color="#093c82"/><stop offset=".75" stop-color="#093c82"/><stop offset="1" stop-color="#093c82"/></linearGradient></defs><rect width="430" height="110" fill="#FFFFFF"/><path d="M430,0 L430,110 L130,110 Q210,90 170,55 Q130,20 210,0 Z" fill="url(#g)"/><path d="M145,110 Q225,90 185,55 Q145,20 225,0" fill="none" stroke="#FFFFFF" stroke-width="1.5" stroke-opacity=".55"/><path d="M165,110 Q245,90 205,55 Q165,20 245,0" fill="none" stroke="#FFFFFF" stroke-width="1" stroke-opacity=".3"/></svg>`;
