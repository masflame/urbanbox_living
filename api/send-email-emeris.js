...
function buildEmailHtml({ subject, body, recipientName }) {
  ...
  const swooshSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 430 110" preserveAspectRatio="none"><defs><linearGradient id="g" x1="1" y1="0" x2="0" y2="0"><stop offset="0" stop-color="${BRAND.tealDp}"/><stop offset=".45" stop-color="${BRAND.tealDk}"/><stop offset=".75" stop-color="${BRAND.teal}"/><stop offset="1" stop-color="#FFFFFF"/></linearGradient></defs><rect width="430" height="110" fill="#FFFFFF"/><path d="M430,0 L430,110 L80,110 C-40,80 -40,30 80,0 Z" fill="#115063"/><path d="M80,0 C-40,30 -40,80 80,110 L95,110 C-25,80 -25,30 95,0 Z" fill="#246277"/><path d="M95,0 C-25,30 -25,80 95,110 L115,110 C-5,80 -5,30 115,0 Z" fill="#246277"/><path d="M95,110 C-25,80 -25,30 95,0" fill="none" stroke="#FFFFFF" stroke-width="1.5" stroke-opacity=".55"/><path d="M115,110 C-5,80 -5,30 115,0" fill="none" stroke="#FFFFFF" stroke-width="1" stroke-opacity=".3"/></svg>`;
