...
function buildEmailHtml({ subject, body, recipientName }) {
  ...
  // The two white guide curves visually divide the swoosh into 3 strips on the
  // left side of the gradient. The first (outermost) strip is filled solid
  // #0B5063 so it reads as a distinct deep-teal band along the curve.
  const swooshSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 430 110" preserveAspectRatio="none"><defs><linearGradient id="g" x1="1" y1="0" x2="0" y2="0"><stop offset="0" stop-color="${BRAND.tealDp}"/><stop offset=".45" stop-color="${BRAND.tealDk}"/><stop offset=".75" stop-color="${BRAND.teal}"/><stop offset="1" stop-color="#FFFFFF"/></linearGradient></defs><rect width="430" height="110" fill="#FFFFFF"/><path d="M430,0 L430,110 L80,110 C200,80 200,30 80,0 Z" fill="#115063"/><path d="M80,0 C200,30 200,80 80,110 L95,110 C215,80 215,30 95,0 Z" fill="#246277"/><path d="M95,0 C215,30 215,80 95,110 L115,110 C235,80 235,30 115,0 Z" fill="#246277"/><path d="M95,110 C215,80 215,30 95,0" fill="none" stroke="#FFFFFF" stroke-width="1.5" stroke-opacity=".55"/><path d="M115,110 C235,80 235,30 115,0" fill="none" stroke="#FFFFFF" stroke-width="1" stroke-opacity=".3"/></svg>`;
        ...
        <table role="presentation" width="660" cellpadding="0" cellspacing="0"
            ...
            <td bgcolor="#FFFFFF" style="padding:0;background:${BRAND.white} !important;background-color:${BRAND.white};line-height:0;font-size:0;border-bottom:4px solid ${BRAND.coral};">
              <table role="presentation" width="660" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="width:660px;max-width:660px;background:${BRAND.white} !important;background-color:${BRAND.white};">
                <tr>
                  ...
                  <td width="430" align="right" valign="middle" bgcolor="#EFF8F7" style="width:430px;padding:0;background-color:${BRAND.light};background-image:url('${swooshUri}'), linear-gradient(245deg, #115063 0%, #115063 55%, ${BRAND.light} 80%, #FFFFFF 100%);background-repeat:no-repeat,no-repeat;background-size:cover,cover;background-position:center,center;">
                    <!--[if gte mso 9]>
          ...
          <tr>
            <td style="padding:18px 36px 8px 36px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
              <p style="margin:0 0 16px 0;font-size:15px;color:${BRAND.tealDp};">
                ${greeting}
              </p>
              ${bodyToHtml(body)}
            </td>
